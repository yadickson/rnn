...
class TestFullyConnectedLayer(TestCase):
    ...
    def test_should_check_bias_array_is_assigned(self) -> None:
        self.assertEqual(self.bias.tolist(), self.layer.bias.tolist())

    def test_should_check_weights_array_is_assigned(self) -> None:
        self.assertEqual(self.weights.tolist(), self.layer.weights.tolist())

    def test_should_check_get_next_trained_data_was_called_one_time(self) -> None:
