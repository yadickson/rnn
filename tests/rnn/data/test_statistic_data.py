...
class TestStatisticData(TestCase):
    ...
    def test_should_return_empty_array_when_method_create_is_called_with_both_params_zero(self):
        result = self.generator.create(input_size=0, output_size=0)
        self.assertEqual(0, result.size)

    def test_should_return_array_with_one_element_when_method_create_is_called_with_both_params_one(self):
