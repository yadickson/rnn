...
class TestStatisticInitializeData(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.initializer = StatisticInitializeData(input_size=self.input_size, output_size=self.output_size, generator=self.generator_stub)

    def test_should_check_input_size_is_assigned(self) -> None:
        self.assertEqual(self.input_size, self.initializer.input_size)

    def test_should_check_output_is_assigned(self) -> None:
        self.assertEqual(self.output_size, self.initializer.output_size)

    def test_should_check_generator_is_assigned(self) -> None:
        self.assertEqual(self.generator_stub, self.initializer.generator)

    def test_should_check_generator_was_called_two_times(self) -> None:
    ...
    def test_should_return_trained_values(self) -> None:
